...
if [ $CODEBUILD_BUILD_SUCCEEDING -eq 1 ]; then
  ...
  location="Report can be retrieved from *GW2 Dev* here: https://s3.console.aws.amazon.com/s3/object/wp-hydra-artefact-bucket?region=eu-west-1&prefix=access-checkout-ios-blackduck/${CODEBUILD_BUILD_NUMBER}/Access_Checkout_iOS_30000270_${REPORT_SDK_VERSION}_BlackDuck_RiskReport.pdf"
else
  emoji=":duck:"
  color="#EA5E1A"
  header="Failed"
