...
DESCRIPTION=$(pact-broker describe-version --pacticipant access-checkout-iOS-sdk --version $CONTRACT_VERSION+$HASH_CODE --broker-base-url https://$PACTBROKER_URL -u $PACTBROKER_URL -p $PACTBROKER_PASSWORD)
