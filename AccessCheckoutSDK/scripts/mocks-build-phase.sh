...
"${INPUT_SOURCE_DIR}/client/validation/AccessCardDelegate.swift" \
"${INPUT_SOURCE_DIR}/client/validation/AccessCvvOnlyDelegate.swift" \
...
"${INPUT_SOURCE_DIR}/validation/model/cvv/CvvValidationStateHandler.swift" \
