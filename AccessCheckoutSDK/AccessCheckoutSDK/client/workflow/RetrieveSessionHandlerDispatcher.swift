class RetrieveSessionHandlerDispatcher {
    ...
    func dispatch(_ merchantId: String, _ baseUrl: String, _ cardDetails: CardDetails, _ sessionType: SessionType, completionHandler: @escaping (Result<String, Error>) -> Void) {
