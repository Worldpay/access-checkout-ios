...
class CardSessionsApiDiscovery {
    ...
    private func createServiceDiscovery(_ baseUrl: String) -> SingleLinkDiscovery {
        ...
        return discoveryFactory.create(toFindLink: ApiLinks.cardSessions.service, usingRequest: request)
    }
    ...
    private func createEndPointDiscovery(_ serviceUrl: String) -> SingleLinkDiscovery {
        ...
        return discoveryFactory.create(toFindLink: ApiLinks.cardSessions.endpoint, usingRequest: request)
    }
}
