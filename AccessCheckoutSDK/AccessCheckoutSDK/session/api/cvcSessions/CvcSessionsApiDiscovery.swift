...
class CvcSessionsApiDiscovery {
    ...
    private func createServiceDiscovery(_ baseUrl: String) -> SingleLinkDiscovery {
        ...
        return discoveryFactory.create(toFindLink: ApiLinks.cvcSessions.service, usingRequest: request)
    }
    ...
    private func createEndPointDiscovery(_ serviceUrl: String) -> SingleLinkDiscovery {
        ...
        return discoveryFactory.create(toFindLink: ApiLinks.cvcSessions.endpoint, usingRequest: request)
    }
}
