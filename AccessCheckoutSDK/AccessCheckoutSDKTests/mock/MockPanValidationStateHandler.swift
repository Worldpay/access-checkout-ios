...
class MockPanValidationStateHandler: PanValidationStateHandler, Cuckoo.ProtocolMock {
    ...
    func handlePanValidation(isValid: Bool, cardBrands: [CardBrandModel]) {
        ...
        return cuckoo_manager.call(
            ...
            defaultCall: __defaultImplStub!.handlePanValidation(
                isValid: isValid, cardBrands: cardBrands))
    ...
    func handleCobrandedCardsUpdate(cardBrands: [CardBrandModel]) {
        ...
        return cuckoo_manager.call(
            """
            handleCobrandedCardsUpdate(cardBrands: [CardBrandModel])
            """,
            ...
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
            defaultCall: __defaultImplStub!.handleCobrandedCardsUpdate(cardBrands: cardBrands))
    ...
    struct __StubbingProxy_PanValidationStateHandler: Cuckoo.StubbingProxy {
        ...
        func handlePanValidation<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(
            isValid: M1, cardBrands: M2
        ) -> Cuckoo.ProtocolStubNoReturnFunction<(Bool, [CardBrandModel])>
        where M1.MatchedType == Bool, M2.MatchedType == [CardBrandModel] {
            let matchers: [Cuckoo.ParameterMatcher<(Bool, [CardBrandModel])>] = [
                wrap(matchable: isValid) { $0.0 }, wrap(matchable: cardBrands) { $0.1 },
            ]
            return .init(
        ...
        func handleCobrandedCardsUpdate<M1: Cuckoo.Matchable>(cardBrands: M1)
