...
class SessionsApiClientMock: SessionsApiClient {
    ...
    public override func createSession(baseUrl: String, merchantId: String, cvv: String, completionHandler: @escaping (Result<String, AccessCheckoutClientError>) -> Void) {
