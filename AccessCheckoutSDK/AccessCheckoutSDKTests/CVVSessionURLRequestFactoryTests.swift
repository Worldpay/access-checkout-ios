...
class CVVSessionURLRequestFactoryTests: XCTestCase {
    ...
    func testCreatesACvvSessionRequest() {
        ...
        let expectedHeaderFields = ["Accept": "application/vnd.worldpay.sessions-v1.hal+json", "Content-Type": "application/vnd.worldpay.sessions-v1.hal+json", "X-WP-SDK": "access-checkout-ios/\(appVersion)"]
